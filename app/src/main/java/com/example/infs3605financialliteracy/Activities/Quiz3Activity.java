...
import com.example.infs3605financialliteracy.Quiz.QuestionsQ3;
...
public class Quiz3Activity extends AppCompatActivity {
    ...
    private QuestionsQ3 mQuestions = new QuestionsQ3();
    ...
    private void testOver() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Quiz3Activity.this);
