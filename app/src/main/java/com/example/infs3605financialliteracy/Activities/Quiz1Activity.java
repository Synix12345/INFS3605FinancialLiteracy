...
import com.example.infs3605financialliteracy.Quiz.QuestionsQ1;
...
public class Quiz1Activity extends AppCompatActivity {
    ...
    private QuestionsQ1 mQuestions = new QuestionsQ1();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private void testOver() {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Quiz1Activity.this);
